...
# load max rmse from sorted data from direct interpolation
def plot_bar(data,figname,axlab,leg,ticklab,size_label=16,capt='(a)',
...
# 3	91	0.00136153	0.0247601	0.0368989	0.992636	45.19	0.0222668	0.0439406
    ...
    # plot_bar(data,figname,axlab,label,ticklab,size_label=16,capt='(a)',style=style)
