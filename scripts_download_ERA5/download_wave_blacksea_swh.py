...
t00=dt.datetime(2017,12,30,0,0,0) #start time download 
t11=dt.datetime(2018,1,1,0,0,0) #endtime download time download 
...
varfname = ["wave"]
varname = [['significant_height_of_combined_wind_waves_and_swell',]]
subdir = ["swh"]
        ...
        if not os.path.isfile(filename):
            c.retrieve(
                ...
                filename)
                    ...
                    # 'data_format': 'netcdf', # new format
                    # 'data_format': 'netcdf_legacy', # old format
