...
#
mypy=/home/g/g260218/.conda/envs/cds/bin/python
...
lat0=40.5
lat1=47
t00="2017-12-30T00:00:00"
t11="2018-01-01T00:00:00"

${mypy} download_wave_blacksea_swh.py ${lon0} ${lon1} ${lat0} ${lat1} ${t00} ${t11}
